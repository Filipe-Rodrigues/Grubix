...
import br.ufla.dcc.PingPong.node.LayerStateChangedProvider;
...
import br.ufla.dcc.grubix.simulator.node.user.os.LocalServiceManager;
import br.ufla.dcc.grubix.simulator.node.user.os.LowerLayerPortedEvent;
...
import br.ufla.dcc.grubix.simulator.node.user.os.PortedPacketReceiver;
...
public class BasicOperatingSystemLayer extends OperatingSystemLayer {
	 ...
	 * @see br.ufla.dcc.PingPong.node.user.os.OperatingSystemLayer#initConfiguration()
	 */
	@Override
	...
	private class ApplicationPortReceiver implements PortedPacketReceiver {
		 ...
		 * @see br.ufla.dcc.PingPong.node.user.os.PortedPacketReceiver#
		 * processPortedPacket(br.ufla.dcc.PingPong.event.OperatingSystemPacket)
		 */
		 ...
		 * @param event event
		 * @see br.ufla.dcc.PingPong.node.user.os.PortedPacketReceiver#
		 * processPortedEvent(br.ufla.dcc.PingPong.node.user.os.PortedEvent)
		 */
