...
public abstract class OperatingSystemLayer extends Layer {
	 ...
	 * @see br.ufla.dcc.PingPong.node.StateIO#getState()
	 */
	 ...
	 * @return false (in 
	 * @see br.ufla.dcc.PingPong.node.StateIO#setState(br.ufla.dcc.PingPong.event.LayerState)
	 */
	 ...
	 * @see br.ufla.dcc.PingPong.node.Layer#sendPacket(br.ufla.dcc.PingPong.event.Packet)
	 */
	@Override
