 ...
 *  @version 18/03/2019
 */
public class EXMacOnisciente  { 
				
	
	/** Observador da simulação */ 
	private static EXMacOnisciente instance = null;
	 ...
	 */
	public EXMacOnisciente() {
				
	}
	
	public static EXMacOnisciente getInstance() {
		if (instance == null){
			instance = new EXMacOnisciente();
		}
