...
public class PaxMacWucTimeOut extends WakeUpCall {
	 ...
	 */
	public PaxMacWucTimeOut(Address sender, Double delay) {
		super(sender, delay);
	 ...
	 * 
	 */
	public PaxMacWucTimeOut(Address sender, Double delay, int sequencial) {
		super(sender, delay);
		startTime = SimulationManager.getInstance().getCurrentTime();
		seqState  = sequencial;
	}
