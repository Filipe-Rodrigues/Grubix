...
public enum PaxMacStateTypes {
	/** Estado inativo, corresponde ao estado em que o rádio e as principais funções do nó estão 
	 * desligados */
	SLEEP,
	
	/** Executando uma prospecção de portadora (Carrier Sense) por um tempo maior, para verificar se 
	 * algum vizinho está transmitindo transmitindo a sequência de RTS*/
	CS_LONG,
	
	/** Executando uma prospecção de portadora (Carrier Sense) por um tempo menor, para verificar se
	 * o canal esta livre naquele instante */
	CS_SHORT,
	
	/** Esperando um earlyACK após envio de preâmbulo*/
	WAITING_CTS,
	
	/** Esperando um CTS confirmado que o canal está livre para receber o dado */
	WAITING_CTS_DATA,
	
	/** Esperando um ACK após envio de dados*/
	WAITING_ACK,
	
	/** Ativo, esperando a recepção de DATA */
	WAITING_DATA,
