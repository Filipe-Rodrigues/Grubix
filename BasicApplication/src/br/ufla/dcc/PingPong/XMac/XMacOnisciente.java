 ...
 *  @version 18/03/2019
 */
public class XMacOnisciente  { 
				
	
	/** Observador da simulação */ 
	private static XMacOnisciente instance = null;
	 ...
	 */
	public XMacOnisciente() {
				
	}
	
	public static XMacOnisciente getInstance() {
		if (instance == null){
			instance = new XMacOnisciente();
		}
