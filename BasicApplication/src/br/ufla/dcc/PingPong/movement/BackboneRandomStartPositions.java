 ...
 * @author jlsx
 */
public class BackboneRandomStartPositions extends br.ufla.dcc.grubix.simulator.movement.StartPositionGenerator {
	...
	@ShoXParameter(description = "Caso de teste para o backbone.", defaultValue = "true")
	private boolean forceCenterNode;
	...
	public final Position newPosition(Node node) {
		if (node.getId().asInt() == 10 && forceCenterNode) {
			return new Position(xSize/2d, ySize/2d);
