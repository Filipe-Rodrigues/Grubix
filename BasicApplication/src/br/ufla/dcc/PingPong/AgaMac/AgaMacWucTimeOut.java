...
public class AgaMacWucTimeOut extends WakeUpCall {
	 ...
	 */
	public AgaMacWucTimeOut(Address sender, Double delay) {
		super(sender, delay);
	 ...
	 * 
	 */
	public AgaMacWucTimeOut(Address sender, Double delay, int sequencial) {
		super(sender, delay);
		startTime = SimulationManager.getInstance().getCurrentTime();
		seqState  = sequencial;
	}
