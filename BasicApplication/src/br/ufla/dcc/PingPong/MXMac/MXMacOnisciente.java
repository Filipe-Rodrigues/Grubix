 ...
 *  @version 18/03/2019
 */
public class MXMacOnisciente  { 
				
	
	/** Observador da simulação */ 
	private static MXMacOnisciente instance = null;
	 ...
	 */
	public MXMacOnisciente() {
				
	}
	
	public static MXMacOnisciente getInstance() {
		if (instance == null){
			instance = new MXMacOnisciente();
		}
