...
public class MXMacConfiguration {
	...
	private int maxBOstarts = MXMacConstants.NUM_MAX_RETRANSMISSIONS;

	/** Máximo de tentativas de reenvio de uma mensagem */
	private int maxSendRetries = MXMacConstants.NUM_MAX_RETRANSMISSIONS;
	...
	private int lengthDATA = MXMacConstants.DATA_LENGTH;

	/** Tamanho do RTS em bits */
	private int lengthRTS = MXMacConstants.RTS_LENGTH;

	/** Tamanho do RTS em bits */
	private int lengthACK = MXMacConstants.ACK_LENGTH;

	/** Tamanho do CTS em bist */
	private int lengthCTS = MXMacConstants.CTS_LENGTH;

	/** Padrão da intensidade de sinal a ser utilizada no envio do de um pacote */
	private double signalStrength = MXMacConstants.SS_DEFAULT;

	/** Tipo de backbone ao qual o nó pertence (0 = não é backbone) */
	private int backboneState;
	...
	/** Construtor */
	public MXMacConfiguration(double lengthCycle, boolean ack) {
		 ...
		 * bit
		 */
		double stepsPBit = (double) Configuration.getInstance().getStepsPerSecond() / MXMacConstants.BPS;
	...
	public void setBackboneType(int backboneType) {
		this.backboneState = backboneType;
	}
