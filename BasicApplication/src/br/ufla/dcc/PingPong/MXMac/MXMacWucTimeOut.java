...
public class MXMacWucTimeOut extends WakeUpCall {
	 ...
	 */
	public MXMacWucTimeOut(Address sender, Double delay) {
		super(sender, delay);
	 ...
	 * 
	 */
	public MXMacWucTimeOut(Address sender, Double delay, int sequencial) {
		super(sender, delay);
		startTime = SimulationManager.getInstance().getCurrentTime();
		seqState  = sequencial;
	}
