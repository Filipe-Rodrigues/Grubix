 ...
 *
 */
public class MXMacState extends LayerState {
	
	/** O estado atual */
	private MXMacStateType state;
	...
	private MXMacActionType action;  
	
	/** Pacote de dados que será enviado */
	private MXMacPacket dataPkt;
	
	/** Pacote RTS que será enviado */
	private MXMacPacket rtsPkt;
	
	/** Pacote recebido na LowerSAP */
	private MXMacPacket recPkt;
    ...
    /** Canal de comunicação atual do nó */
    private int radioChannelMode;
    
	/** Default constructor */
	public MXMacState(MXMacStateType state, int seq) {
		this.state  = state;
	...
	public boolean setState(MXMacStateType newState, double delay) {
	...
	public MXMacStateType getState() {
		return state;
	}
	...
	public MXMacPacket getDataPkt() {
		return dataPkt;
	}

	public void setDataPkt(MXMacPacket dataPkt) {
		this.dataPkt = dataPkt;
	}
	
	public MXMacPacket getRtsPkt() {
		return rtsPkt;
	}

	public void setRtsPkt(MXMacPacket rtsPkt) {
		this.rtsPkt = rtsPkt;
	}
	...
	public MXMacPacket getRecPkt() {
		return recPkt;
	}

	public void setRecPkt(MXMacPacket recPkt) {
		this.recPkt = recPkt;
	}

	public MXMacActionType getAction() {
		return action;
	}

	public void setAction(MXMacActionType action) {
		this.action = action;
	}
	...
	public int getRadioChannelMode() {
		return radioChannelMode;
	}
	
	public void setRadioChannelMode(int mode) {
		radioChannelMode = mode;
	}
