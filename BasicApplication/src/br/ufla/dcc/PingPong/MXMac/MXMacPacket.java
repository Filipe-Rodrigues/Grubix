 ...
 *  @version 18/03/2019
 */
public class MXMacPacket extends MACPacket { 
	 ...
	 */
	public MXMacPacket(Address sender, NodeId receiver, PacketType pkType, double signalStrength) {
	 ...
	 */
	public MXMacPacket(Address sender, LogLinkPacket packet, boolean ackReq) {
