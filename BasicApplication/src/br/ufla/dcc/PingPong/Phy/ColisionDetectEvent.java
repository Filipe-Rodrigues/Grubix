...
/**
 * This event is used, to inform the node, that a packet started to come in.
 * 
 * @author João Giacomin 
 */
public class ColisionDetectEvent extends CrossLayerEvent {
	 ...
	 */
	public ColisionDetectEvent(Address sender, Packet packet) {
		super(sender, packet);
	}
