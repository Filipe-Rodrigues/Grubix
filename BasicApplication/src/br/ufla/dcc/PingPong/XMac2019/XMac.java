...
public class XMac extends MACLayer {
	...
	*/
    ...
    private boolean startRTSsequence() {   
         ...
         */
        XMacPacket newRtsPacket = createCtrlPacket(xState.getReceiverNode(), PacketType.RTS, 
    ...
    private XMacPacket createCtrlPacket(NodeId receiver, PacketType type, int retryCount, 
