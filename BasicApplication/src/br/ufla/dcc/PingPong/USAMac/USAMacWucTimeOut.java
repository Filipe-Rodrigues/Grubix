...
public class USAMacWucTimeOut extends WakeUpCall {
	 ...
	 */
	public USAMacWucTimeOut(Address sender, Double delay) {
		super(sender, delay);
	 ...
	 * 
	 */
	public USAMacWucTimeOut(Address sender, Double delay, int sequencial) {
		super(sender, delay);
		startTime = SimulationManager.getInstance().getCurrentTime();
		seqState  = sequencial;
	}
