...
public class USAMacConfiguration {
	...
	private int maxBOstarts = USAMacConstants.NUM_MAX_RETRANSMISSIONS;

	/** Máximo de tentativas de reenvio de uma mensagem */
	private int maxSendRetries = USAMacConstants.NUM_MAX_RETRANSMISSIONS;
	...
	private int lengthDATA = USAMacConstants.DATA_LENGTH;

	/** Tamanho do RTS em bits */
	private int lengthRTS = USAMacConstants.RTS_LENGTH;

	/** Tamanho do RTS em bits */
	private int lengthACK = USAMacConstants.ACK_LENGTH;

	/** Tamanho do CTS em bist */
	private int lengthCTS = USAMacConstants.CTS_LENGTH;

	/** Padrão da intensidade de sinal a ser utilizada no envio do de um pacote */
	private double signalStrength = USAMacConstants.SS_DEFAULT;
	...
	/** Construtor */
	public USAMacConfiguration(double lengthCycle, boolean ack) {
		 ...
		 * bit
		 */
		double stepsPBit = (double) Configuration.getInstance().getStepsPerSecond() / USAMacConstants.BPS;
