...
public abstract class AbstractServiceManager implements ServiceManager {
	 ...
	 *             for the same type
	 * 
	 * @see br.ufla.dcc.grubix.simulator.node.user.os.ServiceManager#
	 *      init(br.ufla.dcc.grubix.simulator.node.user.os.BasicOperatingSystemLayer)
	 */
	 ...
	 * @see br.ufla.dcc.grubix.simulator.node.user.os.ServiceManager
	 * #lookupService(br.ufla.dcc.grubix.simulator.node.user.os.ServiceType)
	 */
	 ...
	 * 
	 * @see br.ufla.dcc.grubix.simulator.node.user.os.ServiceManager#getServiceList()
	 */
	 ...
	 * @see br.ufla.dcc.grubix.simulator.node.user.os.ServiceManager#stopService(br.ufla.dcc.grubix.simulator.node.user.os.Service)
	 */
	 ...
	 * {@inheritDoc}
	 * @return
	 * @see br.ufla.dcc.grubix.simulator.node.user.os.ServiceManager#getUsedPorts()
	 */
