...
/**
 * A marker interfaces to all {@link Event}s that the
 * {@link OperatingSystemLayer} should distribute the {@link LowerLayerEvent}s to
 * all {@link Service}s that are bound to a {@link Port} by the {@link PortMapper}.
 * 
 * @author wolff
 * 
 */
public interface ServiceMultiplexEvent {
}
